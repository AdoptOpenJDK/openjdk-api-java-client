...
/**
 * A parser that can consume API 2.0 responses.
 */

public final class AOv2Parser
{
  private static final Logger LOG = LoggerFactory.getLogger(AOv2Parser.class);
  ...
  public AOv2Parser()
  {
    this.messages = ResourceBundle.getBundle("net/adoptopenjdk/v1/messages");
  }
